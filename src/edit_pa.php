...
$sql="select * from park_att where pa_id='$id'";
...
<body>
    ...
    <div class="nav">
        <div class="title"><h3>Profile</h3><i class="fa fa-edit"></i></div>
        <div class="name"><p><?php echo $uname ?><i class="fa fa-user"></i></p></div>
    </div>

    <form action="php/update_pa.php" method="post" class="profile">
